...
import { deleteAInvoice } from "../../../api/arounInvoiceApi";
import { Link } from "react-router-dom";

const ArounInvoiceTable = ({ invoices, onEdit, onRefresh }) => {
    ...
    <div className="mt-6 md:p-4 p-2 bg-white shadow-xl rounded-xl border border-gray-200">
      ...
      <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 sm:gap-6 mb-6 bg-white p-4 rounded-xl shadow-sm">
        ...
        <div className="flex justify-between items-end w-full ">
          ...
          <Link to="/admin/arouninvoice">
            <button className="text-blue-600 text-[10px] md:text-xl cursor-pointer">
              Go to Invoice page
            </button>
          </Link>
        </div>
...
export default ArounInvoiceTable;
